        ...
        <div className="flex-1 min-w-0">
          ...
          <p className="text-sm text-muted-foreground mt-1">
            {t(
              ...
              "Plug an external agent (Claude Desktop, ChatGPT, n8n, a custom client) into FinCo-Pilot's built-in MCP server. The token below is scoped to your user and expires in {{days}} days.",
