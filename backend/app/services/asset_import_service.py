...
"ticker, date, quantity, price, fee". FinCo-Pilot already knows how to turn orders
...
#: FinCo-Pilot fields a CSV column can be mapped to, and which of them a file cannot
...
_COLUMN_CANDIDATES: dict[str, tuple[str, ...]] = {
    # One entry per language FinCo-Pilot is translated into, because a broker
