 ...
 *
 * Empty means the plain zip FinCo-Pilot has always produced. A password produces an
 * AES-256 zip, which any standard archiver can open, so the backup stays usable
 * even without FinCo-Pilot. Nothing about the password is sent anywhere else or
