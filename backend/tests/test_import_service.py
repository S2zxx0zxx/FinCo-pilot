...
class TestParseCsvColumnMapping:
    ...
    def test_column_mapping_unrecognized_headers(self):
        """A CSV with headers FinCo-Pilot can't auto-detect parses with an explicit mapping."""
        csv_content = (
...
class TestParseCsvTypeColumn:
    ...
    used directly — enabling all-positive-amount CSVs (like FinCo-Pilot exports).
    """
