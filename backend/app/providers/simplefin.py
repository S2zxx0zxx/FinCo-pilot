...
SimpleFIN Bridge at https://bridge.simplefin.org), pastes it into FinCo-Pilot,
and FinCo-Pilot claims an Access URL that embeds Basic Auth credentials. From then
    ...
    async def _client(self, credentials: dict | None = None) -> httpx.AsyncClient:
        return httpx.AsyncClient(
            ...
            headers={
                ...
                "User-Agent": "FinCo-Pilot/0.1 (+https://github.com/S2zxx0zxx/FinCo-pilot)",
            },
        )
