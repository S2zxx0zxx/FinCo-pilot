...
def _tag_member_self(
    ...
    whose self-member isn't linked to a FinCo-Pilot account.
...
async def _resolve_member_email(
    ...
    """If `email` matches an existing FinCo-Pilot user, return their id.
...
async def create_member(
    ...
    # Auto-link to a real FinCo-Pilot user if the email matches one. The
