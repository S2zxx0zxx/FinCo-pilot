...
# FinCo-Pilot fields a CSV column can be mapped to. Used to validate the
...
def parse_csv(
    ...
    - column_mapping: explicit FinCo-Pilot-field -> CSV-header map. Any field
    ...
    # Normalize the user-supplied column mapping (FinCo-Pilot field -> CSV header).
    mapping = {
    ...
    def resolve_col(field, candidates):
        """Resolve a CSV column for a FinCo-Pilot field.
